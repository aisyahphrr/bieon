...
function ComplaintModal({ isOpen, onClose, realDevices = [] }) {
  ...
  if (submitted) {
    return (
      <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[200] flex items-end sm:items-center justify-center p-0 sm:p-4">
        <div className="bg-white rounded-t-[32px] sm:rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] max-w-md w-full p-10 text-center border-0">
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[200] flex items-end sm:items-center justify-center p-0 sm:p-4">
      <div className="bg-white rounded-t-[32px] sm:rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] max-w-2xl w-full max-h-[90vh] overflow-hidden flex flex-col border-0">
        <div className="bg-white px-5 sm:px-8 py-4 sm:py-6 text-slate-800">
...
function DataModal({ isOpen, onClose, chartType, energySummary }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[200] flex items-end sm:items-center justify-center p-0 sm:p-4">
      <div className="bg-white rounded-t-[32px] sm:rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] max-w-6xl w-full max-h-[90vh] overflow-hidden flex flex-col border-0 animate-in slide-in-from-bottom-10 duration-300">
        <div className="bg-white px-4 sm:px-8 py-4 sm:py-6 text-slate-800">
...
function WarningLimitModal({ isOpen, onClose, limit, setLimit, deposit, setDeposit, onRefresh, energySummary }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[250] flex items-end sm:items-center justify-center p-0 sm:p-4">
      <div className="bg-white rounded-t-[32px] sm:rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] max-w-md w-full max-h-[90vh] overflow-hidden flex flex-col border-0 animate-in slide-in-from-bottom-10 duration-300">
        {/* Header with White BG & Border, responsive padding */}
        <div className="bg-white px-5 sm:px-8 py-5 sm:py-6 text-slate-800">
          <div className="flex items-center justify-between gap-3">
        ...
        <div className="p-5 sm:p-8 overflow-y-auto flex-1 custom-scrollbar">
          {/* Status Section */}
          <div className={`border-0 rounded-2xl p-5 flex flex-col gap-3 mb-8 transition-colors ${isOverBudget ? 'bg-red-50 text-red-600' :
            ...
            <div className="flex justify-between items-center text-sm font-semibold mt-1 pt-3">
  ...
  return (
    ...
    >
      <div className="max-w-[1900px] mx-auto px-3 sm:px-4 md:px-8 py-4 md:py-8 font-sans">
        <div className="bg-white rounded-[24px] border-0 shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-5 mb-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
          <div className="lg:col-span-9 space-y-6 md:space-y-8">
            ...
            <div id="section-energi" className="bg-white rounded-3xl border-0 shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-4 sm:p-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8 p-6 bg-slate-50 rounded-[24px] border-0 items-start">
                {/* Item 1 */}
              ...
              <div className="flex gap-2 mb-6 sm:mb-8 bg-slate-50 p-1.5 rounded-2xl border-0">
                <button
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <div className="hidden lg:block bg-white rounded-[24px] border-0 shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-6">
                ...
                <div className="space-y-3 max-h-[500px] overflow-y-auto pr-2 custom-scrollbar transition-all">
                  {notifications.map((notif) => {
                    ...
                    return (
                      <div
                        key={notif._id}
                        className={`p-3 sm:p-4 rounded-2xl border-0 border-l-4 bg-white ${borderLeftClass} overflow-hidden`}
                      >
            ...
            <div className="bg-white rounded-[24px] border-0 shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-6">
              ...
              <div className="space-y-3">
                {mappedActivities.slice(0, 5).map((activity, idx) => {
                  ...
                  return (
                    <div key={idx} className={`flex items-center gap-3 p-3 rounded-[20px] transition-all duration-300 hover:bg-white hover:scale-[1.02] hover:shadow-md active:scale-95 cursor-pointer group ${activity.color === 'emerald' ? 'bg-eco-50' : 'bg-slate-50'}`}>
