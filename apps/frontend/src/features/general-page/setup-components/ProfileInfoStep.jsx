...
const ProfileInfoStep = ({
    ...
    return (
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            <h1 className="text-[22px] md:text-2xl font-black text-slate-800 mb-1 tracking-tight">Halo! Selamat datang di BIEON</h1>
            <p className="text-[13px] font-bold text-slate-500 mb-8 tracking-tight leading-relaxed w-full">Sebelum mulai memonitor hunian cerdasmu, yuk lengkapi data profil berikut!</p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-4">
                <div className="space-y-2">
                    <label className="block text-[13px] font-bold text-slate-700 pl-1">Nama Depan</label>
                ...
                <div className="space-y-2">
                    <label className="block text-[13px] font-bold text-slate-700 pl-1">Nama Belakang</label>
                    <div className="relative group">
                        <div className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-[#009b7c] transition-colors">
                            <User className="w-4 h-4" />
                        </div>
            ...
            <div className="mb-4 space-y-2">
                <label className="block text-[13px] font-bold text-slate-700 pl-1">Username</label>
                <div className="relative group">
                    <div className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-[#009b7c] transition-colors">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-4">
                <div className="space-y-2">
                    <label className="block text-[13px] font-bold text-slate-700 pl-1">Nomor Telepon</label>
                ...
                <div className="space-y-2">
                    <label className="block text-[13px] font-bold text-slate-700 pl-1">Tanggal Lahir</label>
                    <div className="relative group">
                        <button
                            type="button"
                                ...
                                <div className="absolute top-full right-0 sm:left-0 mt-2 w-[300px] sm:w-[320px] bg-white border border-slate-100 rounded-2xl shadow-2xl p-4 z-40 animate-in fade-in zoom-in-95 duration-200">
                                    ...
                                    <div className="flex items-center justify-between mb-4 px-1">
                                        <div className="flex flex-col">
                                            <span className="text-sm font-black text-slate-800 tracking-tight">{monthNames[viewMonth]}</span>
                                    ...
                                    <div className="grid grid-cols-7 gap-1 mb-2">
                                        {['Su', 'Mo', 'Tu', 'We', 'Th', 'Fr', 'Sa'].map(d => (
                                            <span key={d} className="text-[10px] font-black text-slate-400 text-center uppercase tracking-widest">{d}</span>
                                        ))}
                                    </div>
            ...
            <div className="mb-8 space-y-2">
                <label className="block text-[13px] font-bold text-slate-700 pl-1">Alamat Lengkap</label>
                <div className="relative group">
                    <div className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-[#009b7c] transition-colors">
            ...
            <div className="flex items-center gap-3 mb-10 pl-1 group cursor-pointer" onClick={openTermsModal}>
                ...
                <span className="text-[13px] font-bold text-slate-600 group-hover:text-slate-900 cursor-pointer transition-colors leading-tight">
                    Saya telah membaca dan menyetujui <span className="text-[#009b7c] underline underline-offset-2">Syarat & Ketentuan</span> BIEON
                </span>
            </div>
