...
const SystemHardwareStep = ({
    ...
    return (
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            <h1 className="text-[22px] md:text-2xl font-black text-slate-800 mb-1 tracking-tight">Hubungkan Hunianmu 🔌</h1>
            <p className="text-[13px] font-bold text-slate-500 mb-10 tracking-tight leading-relaxed w-full">
                Daftarkan ID BIEON dan atur tarif listrik untuk mulai memantau penggunaan energi secara real-time.
            </p>

            <div className="space-y-6 mb-12">
                <div className="space-y-2">
                    <label className="block text-[13px] font-bold text-slate-700 pl-1">Nama Sistem / Rumah</label>
                    <div className="relative group">
                        ...
                        <input 
                            type="text" 
                            placeholder='Contoh: "Rumah Utama" atau "Apartemen"' 
                ...
                <div className="space-y-2">
                    <label className="block text-[13px] font-bold text-slate-700 pl-1">ID BIEON</label>
                    <div className="relative group">
                        <div className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-[#009b7c] transition-colors">
                        ...
                        <input 
                            type="text" 
                            placeholder="ID dapat dilihat pada perangkat BIEON Anda" 
                ...
                <div className="space-y-2">
                    <label className="block text-[13px] font-bold text-slate-700 pl-1">Golongan Tarif PLN</label>
                    <div className="relative group">
                        ...
                        >
                            <span className={selectedPln ? 'text-slate-800' : 'text-slate-400 text-[13px] font-semibold'}>
                                {selectedPln || 'Pilih Golongan Tarif Listrik'}
                            </span>
                                    ...
                                    <div className="px-4 pb-3">
                                        <div className="relative group/search">
                                            ...
                                            <input
                                                ...
                                                placeholder="Cari golongan (mis. R1, B-2...)"
                                    ...
                                    <div className="flex-1 overflow-y-auto custom-scrollbar px-1">
                                        {filteredPlnCategories.length === 0 && (
                                            <div className="px-5 py-8 text-center">
                                                ...
                                                <p className="text-[12px] text-slate-500 font-bold">Golongan "{plnSearch}" tidak ditemukan</p>
                                            </div>
                                        )}
